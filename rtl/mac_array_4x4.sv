...
// a combinational adder tree and registered into col_o, giving the
...
module mac_array_4x4 #(
    ...
    input  logic signed [DATA_W-1:0] weight_i [ROWS][COLS],
    input  logic signed [DATA_W-1:0] act_i    [ROWS],
    output logic signed [OUT_W-1:0]  col_o    [COLS]
);
